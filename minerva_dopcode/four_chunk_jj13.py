...
def globgrind(globobs, bstar=False, returnfile=False, printit=False,plot=False,redo=False):
    ...
    for i, ffile in enumerate(files):
        ...
        ofile = os.path.splitext(ffile)[0] + '.chrec12.npy'
...
#globgrind('../../data/n20160606/n20160606.HD122064.0015.proc.fits',bstar=False, returnfile=False, printit=True, plot=False)
